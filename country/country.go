...
var (
	...
	countryCodeMapping = map[string]*Country{
		...
		"496": {"496", "MN", "MNG", "Mongolia", "蒙古", "00976"},
...
func GetByCountryName(name string) (*Country, bool) {
	...
	for _, country := range countryCodeMapping {
		if strings.TrimSpace(strings.ToUpper(country.EnglishCountryName)) == name || strings.TrimSpace(strings.ToUpper(country.ChineseCountryName)) == name {
			return country, true
		}
	}
	return nil, false
